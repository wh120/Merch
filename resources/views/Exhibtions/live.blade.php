...
<head>
    ...
    <title>Live Exhibition - EM-S-ITE</title>
...
<body>
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-white clean-navbar" style="height: 11%;width: 100%;">
        <div class="container"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><i class="fa fa-th-list"></i></button><img data-aos="fade" src="/assets/img/logo.png" style="width: 90px;height: 70px;margin: -20px;padding: 0px;font-size: 17px;"><img src="/assets/img/EMSITE.png" style="height: 41px;width: 153px;margin: 1px 0px;padding: 0px 0px;">
            <div class="collapse navbar-collapse" id="navcol-1" style="height: 40px;width: 979.7px;">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="live.html">Live exhibitions</a></li>
    ...
    <section class="projects-clean" style="height: 1070px;margin: 52px;">
        <div class="container">
            ...
            <div class="row Exhibition">
                ...
                <div class="col item">
                    <a href="{{route('Exhibtions.index',[$exhibtion->Exhibition_Name])}}"> <img class="img-fluid" src="/assets/img/desk.jpg"></a>
