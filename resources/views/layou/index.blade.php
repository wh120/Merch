...
<body>
    ...
    <div class="pc-mob-header pc-header">
        <div class="pcm-logo">
            <img src="/asset/images/logo.png" style="width: 75px;" class="logo logo-lg"> Dashboard
        </div>
        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="../index.html" class="b-brand">
                    <img src="/asset/images/logo.png" style="width: 75px;" class="logo logo-lg">Dashboard Exhibitioin
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{route('Adminex.create')}}" class="pc-link ">
                            ...
                            <span class="pc-mtext">Create</span>
                        </a>
                    </li>
                    ...
                    <li class="pc-item">
                        <a href="{{route('Merch.index')}}" class="pc-link "><span class="pc-micon"><i class="material-icons-two-tone">settings</i></span><span class="pc-mtext">Merches</span></a>
                    </li>

                    <li class="pc-item">
                        <a href="{{route('Contact.index')}}" class="pc-link "><span class="pc-micon"><i class="bi bi-cursor-fill">up</i></span><span class="pc-mtext">Contact</span></a>
                    </li>
