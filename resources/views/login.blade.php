...
<body style="background: var(--bs-white);">
    <section class="border rounded-pill login-clean" style="background: url(&quot;/assets/img/exhibitions-gl-events.jpg&quot;);">
        <form data-aos="zoom-in" data-aos-duration="500" data-aos-delay="50" method="post" action="/checklogin" style="height: 550px;">
            {{csrf_field()}}
            <h2 class="visually-hidden">Login Form</h2>
            <div class="illustration"><img src="/assets/img/f29a1ebaf6ba41c8871ee1ace3098555.png"></div>
            <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Email"></div>
            <div class="mb-3"><input class="form-control" type="password" name="password" placeholder="Password"></div>
            <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: var(--bs-green);">Log In</button></div><a class="forgot" href="#">Forgot your email or password?</a>
        </form>
    </section>
